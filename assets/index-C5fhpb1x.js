...
var Row = /* @__PURE__ */ ((Row2) => {
  Row2[Row2["Front"] = 0] = "Front";
  Row2[Row2["Mid"] = 1] = "Mid";
  Row2[Row2["Back"] = 2] = "Back";
  return Row2;
})(Row || {});
const ROW_NAMES = {
  [
...
var DamageType = /* @__PURE__ */ ((DamageType2) => {
  DamageType2["Physical"] = "physical";
  DamageType2["Magical"] = "magical";
  DamageType2["Pure"] = "pure";
  return DamageType2;
})(DamageType || {});
var StatusType = /* @__PURE__ */ ((StatusType2) => {
  StatusType2["Stun"] = "stun";
  StatusType2["Sleep"] = "sleep";
  StatusType2["Petrify"] = "petrify";
  StatusType2["Freeze"] = "freeze";
  StatusType2["Bind"] = "bind";
  StatusType2["Burn"] = "burn";
  StatusType2["ArmorBreak"] = "armorBreak";
  StatusType2["Disarm"] = "disarm";
  StatusType2["Curse"] = "curse";
  StatusType2["Ruin"] = "ruin";
  StatusType2["Silence"] = "silence";
  StatusType2["Inspire"] = "inspire";
  StatusType2["Bloodrage"] = "bloodrage";
  StatusType2["Stealth"] = "stealth";
  StatusType2["Shield"] = "shield";
  return StatusType2;
})(StatusType || {});
const pp = {
  id: "pp",
...
const hd = {
  ...
  skill: {
    ...
    damage: [{ type: DamageType.Physical, atkRatio: 2 }],
    aoe: { maxTargets: 3 }
  }
};
const fxz = {
...
const bmxz = {
  ...
  skill: {
    ...
    damage: [{ type: DamageType.Magical, atkRatio: 2 }],
    interruptOnAttack: true,
    aoe: { maxTargets: 9 }
  }
};
...
const wqqs = {
  ...
  skill: {
    ...
    damage: [{ type: DamageType.Pure, atkRatio: 1 }],
...
const klb = {
  ...
  skill: {
    ...
    castTime: 0,
    description: "普通攻击",
    damage: [{ type: DamageType.Physical, atkRatio: 1 }]
  }
};
const yammxz = {
  id: "yammxz",
...
function countRaceOnTeam(units) {
...
const CharacterInfoCard = ({ name, race, level, stats, talent, skillName, skillDesc, skillCD, skillCast, onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 20, fontWeight: 700, color: "#fff" }, children: name }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 13, color: cfg.color, fontWeight: 600, marginBottom: 10 }, children: [
      cfg.label,
      " · Lv.",
      level
    ] }),
    ...
    }, children: stats.map(({ label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888" }, children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fff", fontWeight: 600 }, children: value })
    ] }, label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 10 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "#ff9800", fontWeight: 600, marginBottom: 3 }, children: "天赋" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "#ccc", lineHeight: 1.5 }, children: talent })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 12, color: "#2196f3", fontWeight: 600, marginBottom: 3 }, children: [
        "技能：",
        skillName,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#888", marginLeft: 8, fontWeight: 400, fontSize: 12 }, children: [
          "CD ",
          skillCD,
          "s",
          skillCast > 0 ? ` · 施法${skillCast}s` : " · 瞬发"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "#ccc", lineHeight: 1.5 }, children: skillDesc })
    ] })
  ] }) });
};
const CharDetail = ({ char, onClose }) => {
  if (!char) return null;
  const s = char.stats;
...
function useSavedTeams() {
  ...
  const saveTeam = reactExports.useCallback((name, units) => {
    const id = genId();
    const team = { id, name, units: units.map((u) => ({ ...u })), createdAt: Date.now() };
    setTeams((prev) => {
  ...
  const deleteTeam = reactExports.useCallback((id) => {
    setTeams((prev) => prev.filter((t) => t.id !== id));
  }, []);
  return { teams, saveTeam, deleteTeam };
}
function calcBondsFromDefs(units) {
  const counts = {};
  for (const u of units) {
  ...
  return Object.entries(counts).filter(([_, c]) => c >= 3).map(([race, count]) => {
    const eff = BOND_EFFECTS[race];
    const desc = eff ? [eff.attackBonus ? `攻+${eff.attackBonus}%` : "", eff.defenseBonus ? `防+${eff.defenseBonus}%` : "", eff.special || ""].filter(Boolean).join(" ") : "";
    return { race, count, desc };
  });
}
const RACE_ORDER = ["beast", "hunter", "warrior", "mage", "undead", "dragon"];
const RC$1 = { beast: "#8d6e63", hunter: "#4caf50", warrior: "#f44336", mage: "#2196f3", undead: "#9c27b0", dragon: "#ff9800" };
const RL = { beast: "兽族", hunter: "猎人", warrior: "战士", mage: "法师", undead: "亡灵", dragon: "龙族" };
const ROW_LABELS = ["前排", "中排", "后排"];
const sbtn = { padding: "1px 6px", fontSize: 9, background: "#333", color: "#aaa", border: "none", borderRadius: 2, cursor: "pointer" };
function posRC(i) {
  return { row: Math.floor(i / 3), col: i % 3 };
}
function TeamPanel({ side, label, color, onChange }) {
  const { teams, saveTeam } = useSavedTeams();
  const [grid, setGrid] = reactExports.useState(Array.from({ length: 9 }, () => ({ charId: null })));
  const [sel, setSel] = reactExports.useState(null);
  const [detail, setDetail] = reactExports.useState(null);
  const [pool, setPool] = reactExports.useState(true);
  const [exp, setExp] = reactExports.useState({ beast: true, hunter: true, warrior: true, mage: true, undead: true, dragon: true });
  const [sname, setSname] = reactExports.useState("");
  const placed = grid.filter((s) => s.charId).length;
  const bonds = calcBondsFromDefs(grid);
  const emit = (g) => {
    const data = g.map((s, i) => {
      const rc = posRC(i);
      return { charId: s.charId || "", row: rc.row, col: rc.col };
    }).filter((s) => s.charId);
  ...
  const load = (t) => {
    const ng = Array.from({ length: 9 }, () => ({ charId: null }));
    ((t == null ? void 0 : t.units) || t || []).slice(0, 9).forEach((u, i) => {
      if (u.charId) ng[i] = { charId: u.charId };
    });
    setGrid(ng);
    emit(ng);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 8 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 3 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 14, fontWeight: 700, color }, children: [
        label,
        " ",
        placed,
        "/8"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 3 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setPool(!pool), style: sbtn, children: [
          pool ? "🔼" : "🔽",
          "角色"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: clear, style: sbtn, children: "清空" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: randomize, style: sbtn, children: "🎲随机" })
      ] })
    ] }),
    bonds.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 3, flexWrap: "wrap", marginBottom: 3 }, children: bonds.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: {
      fontSize: 9,
      padding: "2px 6px",
      borderRadius: 3,
      background: RC$1[b.race] || "#555",
      color: "#000",
      fontWeight: 700
    }, children: [
      RL[b.race],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "24px 1fr", gap: 2, marginBottom: 4, background: "#1a1a2e", padding: 4, borderRadius: 6, border: "1px solid #333" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "contents" }, children: [0, 1, 2].map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 9, color: "#555", display: "flex", alignItems: "center", justifyContent: "center" }, children: ROW_LABELS[r] }, r)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 2 }, children: grid.map((slot, i) => {
        const ch = slot.charId ? CHARACTER_MAP.get(slot.charId) || null : null;
        const bg = ch ? RC$1[ch.race] || color : "#333";
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            onClick: () => clickGrid(i),
            ...
            style: {
              ...
              border: `2px solid ${ch ? bg : "#222"}`,
              cursor: sel ? "pointer" : "default",
              display: "flex",
              alignItems: "center",
              justifyContent: "center"
            },
            children: ch ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 10, fontWeight: 700, color: "#fff" }, children: ch.name }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 8, color: "#333" }, children: "空" })
          },
          i
        );
      }) })
    ] }),
    pool && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 2, flexWrap: "wrap", marginBottom: 3 }, children: raceRows.map((rr) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          onClick: () => setExp((e) => ({ ...e, [rr.race]: !e[rr.race] })),
          style: { fontSize: 9, fontWeight: 700, color: RC$1[rr.race] || "#888", padding: "1px 4px", cursor: "pointer" },
          children: [
            RL[rr.race],
            " ",
            rr.open ? "▲" : "▼"
      ...
      rr.open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 1, flexWrap: "wrap", padding: "1px 0 2px 3px" }, children: rr.chars.map((ch) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 1 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: { padding: "2px 5px", fontSize: 9, background: "#222", border: "1px solid #444", borderLeft: "none", borderRadius: "0 3px 3px 0", color: "#888", cursor: "pointer" },
            children: "👁"
          }
        )
      ] }, ch.id)) })
    ] }, rr.race)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 3, alignItems: "center", flexWrap: "wrap" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          value: sname,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: { padding: "1px 5px", fontSize: 9, background: "#4caf50", color: "#000", border: "none", borderRadius: 2, cursor: "pointer" },
          children: "💾"
        }
      ),
      teams.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { onChange: (e) => {
        const idx = Number(e.target.value);
        if (idx >= 0) {
          const t = teams[idx];
          if (t) load(t);
        }
      }, style: { fontSize: 9, padding: "1px 3px", background: "#222", color: "#ccc", border: "1px solid #444", borderRadius: 2, maxWidth: 100 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "📂读取" }),
        teams.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: i, children: t.name }, t.id))
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 8, color: "#444", marginTop: 2, display: "flex", justifyContent: "space-between" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "点击名→格子 · 右键移除 · 留1空" }) }),
    detail && /* @__PURE__ */ jsxRuntimeExports.jsx(CharDetail, { char: detail, onClose: () => setDetail(null) })
  ] });
}
const TeamSetup = ({ onStart }) => {
  const [ally, setAlly] = reactExports.useState([]);
  const [enemy, setEnemy] = reactExports.useState([]);
  const { teams, deleteTeam } = useSavedTeams();
  const [delMode, setDelMode] = reactExports.useState(false);
  const ready = ally.length > 0 && enemy.length > 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "6px 8px 30px", maxWidth: 600, margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 14, fontWeight: 700, color: "#fff" }, children: "阵容配置" }),
    ...
    delMode && teams.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#1a1a2e", border: "1px solid #f44336", borderRadius: 6, padding: 8, marginBottom: 6 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 10, color: "#f44336", marginBottom: 4 }, children: "点击删除存档：" }),
      teams.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "3px 0", borderBottom: "1px solid #222" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: "#ccc" }, children: t.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => deleteTeam(t.id),
            style: { padding: "1px 8px", fontSize: 9, background: "#f44336", color: "#fff", border: "none", borderRadius: 3, cursor: "pointer" },
            children: "删除"
          }
        )
      ] }, t.id))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TeamPanel, { side: "ally", label: "🟦 我方", color: "#4fc3f7", onChange: setAlly }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", fontSize: 12, color: "#444", padding: "1px 0" }, children: "⚔" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TeamPanel, { side: "enemy", label: "🟥 敌方", color: "#ef5350", onChange: setEnemy }),
    !ready && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", color: "#555", fontSize: 10, marginTop: 6 }, children: "配置双方阵容即可开战" })
  ] });
};
const SC = { stun: "#f44", sleep: "#9c27b0", petrify: "#607d8b", freeze: "#03a9f4", bind: "#ff9800", burn: "#ff5722", curse: "#e91e63", silence: "#795548", inspire: "#4caf50" };
const SE = { stun: "💫", sleep: "💤", petrify: "🗿", freeze: "❄️", bind: "🔗", burn: "🔥", curse: "☠️", silence: "🔇", inspire: "✨" };
const RC = { beast: "#8d6e63", hunter: "#4caf50", warrior: "#f44336", mage: "#2196f3", undead: "#9c27b0", dragon: "#ff9800" };
const BG = { beast: "linear-gradient(135deg,#4e342e,#3e2723)", hunter: "linear-gradient(135deg,#1b5e20,#2e7d32)", warrior: "linear-gradient(135deg,#b71c1c,#c62828)", mage: "linear-gradient(135deg,#0d47a1,#1565c0)", undead: "linear-gradient(135deg,#4a148c,#6a1b9a)", dragon: "linear-gradient(135deg,#e65100,#ef6c00)" };
const UnitSprite = ({ unit, onClick }) => {
  var _a, _b;
  const rc = RC[unit.def.race] || "#999";
  const [dmgFlash, setDmgFlash] = reactExports.useState(false);
  const [healFlash, setHealFlash] = reactExports.useState(false);
  const [floatText, setFloatText] = reactExports.useState(null);
  const [floatColor, setFloatColor] = reactExports.useState("#f44336");
  const [skLabel, setSkLabel] = reactExports.useState(null);
  const [skBubble, setSkBubble] = reactExports.useState(null);
  const [animCls, setAnimCls] = reactExports.useState("");
  const dKey = unit.lastDamage ? `${unit.lastDamage.value}_${unit.lastDamage.time}` : "";
  const hKey = unit.lastHeal ? `${unit.lastHeal.value}_${unit.lastHeal.time}` : "";
  const skKey = ((_a = unit.lastSkillCast) == null ? void 0 : _a.time) ?? 0;
  ((_b = unit.lastAction) == null ? void 0 : _b.time) ?? 0;
  reactExports.useEffect(() => {
    if (!dKey) return;
    setDmgFlash(true);
    const dmg = unit.lastDamage;
    const color = dmg.type === "magical" ? "#7c4dff" : dmg.type === "pure" ? "#fff" : "#f44336";
    setFloatColor(color);
  ...
  reactExports.useEffect(() => {
    ...
    setSkLabel(sk.name);
    const target = (_a2 = unit.lastAction) == null ? void 0 : _a2.targetName;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        border: `2px solid ${unit.isDead ? "#555" : rc}`,
        display: "flex",
        ...
        overflow: "hidden",
        padding: "2px 4px",
        boxShadow: dmgFlash ? "inset 0 0 20px rgba(244,67,54,0.8)" : healFlash ? "inset 0 0 20px rgba(76,175,80,0.8)" : "none"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: 4, background: "#1a1a1a" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: `${Math.max(0, hp * 100)}%`, height: "100%", background: hp > 0.5 ? "#4caf50" : hp > 0.25 ? "#ff9800" : "#f44336", transition: "width 0.12s" } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: 5, right: 4, fontSize: 8, padding: "1px 4px", borderRadius: 2, background: rc, color: "#000", fontWeight: 700 }, children: RACE_NAMES[unit.def.race] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, fontWeight: 700, color: "#fff", textShadow: "0 1px 3px rgba(0,0,0,0.9)", lineHeight: 1.2, marginTop: 2 }, children: unit.def.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 10, color: "#ddd" }, children: [
          Math.max(0, Math.floor(unit.currentHp)),
          "/",
          unit.maxHp
        ] }),
        skBubble && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          position: "absolute",
          top: -8,
          left: "50%",
        ...
        floatText && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          position: "absolute",
          top: "28%",
          left: "50%",
        ...
        unit.isCasting && !unit.isDead && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: 14, left: 3, fontSize: 8, color: "#ffeb3b", fontWeight: 700, animation: "pulse 0.5s infinite" }, children: "✦" }),
        unit.statuses.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", bottom: 1, left: 1, right: 1, display: "flex", gap: 1, flexWrap: "wrap", justifyContent: "center" }, children: unit.statuses.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
          fontSize: 8,
          padding: "0 3px",
          borderRadius: 2,
          ...
          fontWeight: 600,
          lineHeight: "14px"
        }, children: SE[s.type] || s.type.slice(0, 2) }, i)) })
      ]
    }
  );
};
const bondRC = { beast: "#8d6e63", hunter: "#4caf50", warrior: "#f44336", mage: "#2196f3", undead: "#9c27b0", dragon: "#ff9800" };
const bondNM = { beast: "兽", hunter: "猎", warrior: "战", mage: "法", undead: "亡", dragon: "龙" };
const BattleField = ({ battle, side, onUnitClick }) => {
  var _a;
  ...
  const bonds = ((_a = battle.bonds) == null ? void 0 : _a[side]) || [];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    gap: 4,
    padding: 6,
    background: side === "ally" ? "linear-gradient(180deg, #1a237e66, #0d47a133)" : "linear-gradient(180deg, #b71c1c66, #880e4f33)",
    borderRadius: 10,
    border: isFinished ? `4px solid ${won ? "#4caf50" : "#f44336"}` : "4px solid transparent",
    position: "relative"
  }, children: [
    isFinished && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      position: "absolute",
      top: "40%",
      left: "50%",
      transform: "translate(-50%,-50%)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", fontSize: 13, fontWeight: 700, color: "#ccc" }, children: side === "ally" ? "我方" : "敌方" }),
    bonds.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 3, justifyContent: "center", flexWrap: "wrap", marginBottom: 2 }, children: bonds.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: {
      fontSize: 8,
      padding: "1px 5px",
      borderRadius: 3,
      ...
      bondNM[b.race] || b.race,
      "×",
      b.count,
      "🌟"
    ] }, b.race)) }),
    rowOrder.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 3, alignItems: "center", minHeight: 76 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 26, fontSize: 10, color: "#666", fontWeight: 600, textAlign: "center", flexShrink: 0 }, children: ROW_NAMES[row] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 3 }, children: [0, 1, 2].map((col) => {
        const unit = grid[row][col];
        return unit ? /* @__PURE__ */ jsxRuntimeExports.jsx(UnitSprite, { unit, onClick: () => onUnitClick == null ? void 0 : onUnitClick(unit) }, unit.id) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          height: 74,
          borderRadius: 6,
          display: "flex",
          alignItems: "center",
        ...
        }, children: "空" }, `e-${row}-${col}`);
      }) })
    ] }, row))
  ] });
};
const TYPE_COLORS = { damage: "#f44336", heal: "#4caf50", status: "#ff9800", skill: "#2196f3", death: "#9c27b0", system: "#aaa" };
const BattleLog = ({ entries }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    entries.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: TYPE_COLORS[e.type] || "#ccc" }, children: [
...
const TABS = [
  { key: "dmg", label: "⚔输出", color: "#f44336", field: "totalDamageDealt" },
  { key: "taken", label: "🛡承伤", color: "#ff9800", field: "totalDamageReceived" },
  { key: "heal", label: "💚治疗", color: "#4caf50", field: "totalHealingDone" }
];
const MAX_RANK = 5;
function UnitLine({ s, i, val, maxVal, color }) {
  const cfg = RACE_CONFIG[s.race] || { color: "#888", short: "?" };
  const pct = maxVal > 0 ? (val / maxVal * 100).toFixed(1) : "0";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4, padding: "2px 0", fontSize: 11 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#555", width: 14, textAlign: "right", fontSize: 10 }, children: i + 1 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: cfg.color, fontSize: 10, fontWeight: 700, width: 14 }, children: cfg.short }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#ccc", width: 56, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontWeight: 500 }, children: s.name }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, height: 8, background: "#1a1a1a", borderRadius: 4, overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: `${val / maxVal * 100}%`, height: "100%", background: color, borderRadius: 4, transition: "width 0.3s" } }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fff", width: 40, textAlign: "right" }, children: val.toLocaleString() }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#666", width: 32, textAlign: "right", fontSize: 10 }, children: [
      pct,
      "%"
    ] })
  ] });
}
function buildRankings(stats, team, field) {
  const us = stats.filter((s) => s.team === team && s[field] > 0);
  const total = us.reduce((a, s) => a + s[field], 0);
  const sorted = [...us].sort((a, b) => b[field] - a[field]);
  const max = sorted.length > 0 ? sorted[0][field] : 1;
  return { lines: sorted.slice(0, MAX_RANK), total, max };
}
function TeamStats({ stats, team, label, color }) {
  const [tab, setTab] = reactExports.useState("dmg");
  const activeTab = TABS.find((t) => t.key === tab) || TABS[0];
  const { lines, total, max } = reactExports.useMemo(
    () => buildRankings(stats, team, activeTab.field),
    [stats, team, activeTab.field]
  );
  if (stats.filter((s) => s.team === team).length === 0) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 8 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 700, color, marginBottom: 4 }, children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 2, marginBottom: 4 }, children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    lines.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(UnitLine, { s, i, val: s[activeTab.field], maxVal: max, color: activeTab.color }, s.unitId)),
    lines.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "#555" }, children: "暂无数据" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 10, color: "#555", marginTop: 2 }, children: [
      "总计 ",
      total.toLocaleString()
    ] })
  ] });
}
const StatsPanel = ({ stats }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#111", border: "1px solid #333", borderRadius: 8, padding: 10 }, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(TeamStats, { stats, team: "ally", label: "我方", color: "#4fc3f7" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(TeamStats, { stats, team: "enemy", label: "敌方", color: "#ef5350" })
] });
...
function calcDefReduction(def) {
  return Math.min(def / (def + 200), 0.8);
}
function getBlockChance(race, isFrontRow = false) {
  let chance;
  switch (race) {
    case Race.Beast:
    case Race.Warrior:
...
function calcDamage(attacker, defender, skillAtkRatio, type, extraOpts) {
  ...
  if (((extraOpts == null ? void 0 : extraOpts.evasion) ?? 0) > 0 || ((extraOpts == null ? void 0 : extraOpts.hitRateMod) ?? 0) !== 0) {
    const hit = checkHit((extraOpts == null ? void 0 : extraOpts.hitRateMod) ?? 0, (extraOpts == null ? void 0 : extraOpts.evasion) ?? 0);
    result.hit = hit;
    if (!hit) {
  ...
  if (type === DamageType.Pure) {
    if (extraOpts == null ? void 0 : extraOpts.defMultiplier) {
      result.rawDamage = defender.currentPhysicalDef * extraOpts.defMultiplier;
    } else if (extraOpts == null ? void 0 : extraOpts.defSquaredDiv) {
    ...
    } else if (extraOpts == null ? void 0 : extraOpts.selfDefMultiplier) {
      result.rawDamage = attacker.currentPhysicalDef * extraOpts.selfDefMultiplier;
    } else if (extraOpts == null ? void 0 : extraOpts.targetMaxHpRatio) {
      result.rawDamage = defender.maxHp * extraOpts.targetMaxHpRatio;
    } else {
      result.rawDamage = attacker.currentAttack * (skillAtkRatio ?? 1) + ((extraOpts == null ? void 0 : extraOpts.fixedAdd) ?? 0);
    }
  } else {
    const atk = attacker.currentAttack;
    result.rawDamage = atk * skillAtkRatio + ((extraOpts == null ? void 0 : extraOpts.fixedAdd) ?? 0);
  }
  if (type === DamageType.Physical) {
    let def = defender.currentPhysicalDef;
    if (extraOpts == null ? void 0 : extraOpts.ignoreBaseDef) {
      def = def * 0.5;
    }
  ...
  if ((extraOpts == null ? void 0 : extraOpts.cdrOverride) !== void 0) {
  ...
  if (attacker.def.id === "dyq" && result.finalDamage > 0) {
    const isSkill = (extraOpts == null ? void 0 : extraOpts.isSkill) || false;
...
function applyFatalStrike(attacker, damage, isSkill) {
...
function calcHeal(healer, target, atkRatio, extraOpts) {
  let heal = healer.currentAttack * atkRatio + ((extraOpts == null ? void 0 : extraOpts.fixedAdd) ?? 0);
  if (extraOpts == null ? void 0 : extraOpts.targetMaxHpRatio) {
    heal += target.maxHp * extraOpts.targetMaxHpRatio;
  }
  if (extraOpts == null ? void 0 : extraOpts.targetLostHpRatio) {
...
function registerSkillHandler(skillId, handler) {
  registry.set(skillId, handler);
}
function getSkillHandler(skillId) {
  return registry.get(skillId);
}
registerSkillHandler("lyz_heal", (caster, state, log, targets) => {
  if (!caster.def.skill.heal) return;
  const allies = state.units.filter((u) => u.team === caster.team && !u.isDead);
  const deadDragons = state.units.filter((u) => u.team === caster.team && u.isDead && u.def.race === "dragon");
  caster.castCount = (caster.castCount || 0) + 1;
  const upgraded = caster.castCount >= 4;
  let targetsList = allies.filter((u) => u.def.race === "dragon").sort((a, b) => a.currentHp / a.maxHp - b.currentHp / b.maxHp);
...
registerSkillHandler("xjl_link", (caster, state, log) => {
  const allies = state.units.filter((u) => u.team === caster.team && !u.isDead && u.id !== caster.id);
  if (allies.length === 0) return;
  const mages = allies.filter((u) => u.def.race === "mage");
  const target = mages[0] || allies.sort((a, b) => b.currentAttack - a.currentAttack)[0];
  if (target) {
...
registerSkillHandler("mrsz_doom", (caster, state, log) => {
  ...
  const enemies = state.units.filter((u) => u.team !== caster.team && !u.isDead);
  const topDmg = enemies.sort((a, b) => (b.totalDamageDealt || 0) - (a.totalDamageDealt || 0))[0];
  if (topDmg) {
...
function lvScale(base, growth, level) {
  return base + growth * (level - 1);
}
function createUnit(def, level, team, row, col = 0) {
  ...
  return {
    ...
    isDead: false,
    statuses: [],
    autoAttackTargetId: void 0,
    evasion: def.id === "sszs" ? 0.25 : 0,
    hitRateMod: def.id === "hd" ? -0.1 : 0
  };
}
function getAlive(state, team) {
  return state.units.filter((u) => !u.isDead && (team === void 0 || u.team === team));
}
function getEnemies(state, selfTeam) {
  return state.units.filter((u) => u.team !== selfTeam && !u.isDead);
}
function pickTarget(enemies, rowPref) {
  if (enemies.length === 0) return void 0;
  if (rowPref && rowPref.length > 0) {
    const total2 = rowPref.reduce((s, r) => s + r.chance, 0);
  ...
  const chances = hasFront ? [{ row: Row.Front, c: 50 }, { row: Row.Mid, c: 30 }, { row: Row.Back, c: 20 }] : [{ row: Row.Mid, c: 60 }, { row: Row.Back, c: 40 }];
...
function initBattle(allyChars, enemyChars) {
  nextUnitId = 0;
  const makeUnits = (chars, team) => chars.map((c) => {
  ...
  function calcBonds(us) {
    const rc = {};
    for (const u of us.filter((u2) => !u2.isDead)) {
...
function updateSkills(state) {
  ...
  for (const unit of getAlive(state)) {
    ...
    const cannotCast = [StatusType.Stun, StatusType.Sleep, StatusType.Petrify, StatusType.Freeze, StatusType.Silence].some((t) => unit.statuses.some((s) => s.type === t));
    const isBound = unit.statuses.some((s) => s.type === StatusType.Bind);
    if (cannotCast) continue;
    if (isBound && ((_a = unit.def.skill.tags) == null ? void 0 : _a.some((t) => t === "切入" || t === "移动"))) continue;
...
function updateAutoAttacks(state) {
  for (const unit of getAlive(state)) {
    const cannotAttack = [StatusType.Stun, StatusType.Sleep, StatusType.Petrify, StatusType.Freeze, StatusType.Disarm].some((t) => unit.statuses.some((s) => s.type === t));
...
function updateDeaths(state) {
  for (const u of state.units) {
    ...
    if (u.def.race === "undead" && !u.hasRevived) {
      const alive = state.units.filter((x) => x.team === u.team && !x.isDead);
      const totalU = state.units.filter((x) => x.team === u.team && x.def.race === "undead").length;
      if (totalU >= 3) {
        for (const m of alive) {
          if (m.def.race === "undead") m.currentHp = Math.max(1, Math.floor(m.currentHp * 0.95));
        }
...
function updateRevivals(state) {
  for (const u of state.units) {
    ...
    if (u.invincibleTimer && u.invincibleTimer > 0) {
      ...
      if (u.invincibleTimer <= 0) u.invincibleTimer = void 0;
    }
  }
}
function updateVictory(state) {
  const a = getAlive(state).filter((u) => u.team === "ally");
  const e = getAlive(state).filter((u) => u.team === "enemy");
...
function updateBonds(state) {
  const calc = (team) => {
    const rc = {};
    for (const u of state.units.filter((x) => x.team === team && !x.isDead))
      rc[u.def.race] = (rc[u.def.race] || 0) + 1;
    return Object.entries(rc).filter(([_, c]) => c >= 3).map(([r, c]) => ({ race: r, count: c }));
  };
...
function executeSkill(caster, state, log) {
  ...
  if (handler) {
    const scriptTargets = sk.aoe ? shuffle(enemies).slice(0, sk.aoe.maxTargets || enemies.length) : [pickTarget(enemies, sk.priority)].filter(Boolean);
    handler(caster, state, log, scriptTargets);
    return;
  }
  let actionTargets = [];
  const isCutIn = (_a = sk.tags) == null ? void 0 : _a.includes("切入");
  if (isCutIn && enemies.length > 0) {
    ...
    for (const t of cutTargets) {
      ...
      const targetTeam = state.units.filter((u) => u.team === t.team && !u.isDead);
      const hunterCount = targetTeam.filter((u) => u.def.race === "hunter").length;
      if (hunterCount >= 3) {
  ...
  if (sk.damage && enemies.length > 0) {
    ...
    for (const dmgFormula of sk.damage) {
      for (const t of targets) {
        ...
        const mageCnt = state.units.filter((u) => u.team === caster.team && !u.isDead && u.def.race === "mage").length;
  ...
  if (sk.effects) {
    const targets = sk.aoe ? shuffle(enemies).slice(0, sk.aoe.maxTargets || enemies.length) : [pickTarget(enemies, sk.priority)].filter(Boolean);
    for (const t of targets) {
...
function addStat(state, unitId, field, value) {
  var _a;
  const s = (_a = state.stats) == null ? void 0 : _a.find((st) => st.unitId === unitId);
...
function useBattle() {
  ...
  const lastTime = reactExports.useRef(0);
  const accumulatorRef = reactExports.useRef(0);
  const speedRef = reactExports.useRef(1);
  const startBattle = reactExports.useCallback((allyTeam, enemyTeam) => {
    const battle = initBattle(allyTeam, enemyTeam);
  ...
  reactExports.useEffect(() => {
    ...
    const tick = () => {
      ...
      const elapsed = (now - lastTime.current) / 1e3;
...
const App = () => {
  ...
  const [page, setPage] = reactExports.useState("setup");
  const [selectedUnit, setSelectedUnit] = reactExports.useState(null);
  const [allyTeam, setAllyTeam] = reactExports.useState([]);
  const [enemyTeam, setEnemyTeam] = reactExports.useState([]);
  const [showExtra, setShowExtra] = reactExports.useState(false);
  const handleStart = (ally, enemy) => {
    setAllyTeam(ally);
    setEnemyTeam(enemy);
  ...
  if (page === "setup") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { minHeight: "100vh", background: "#0d0d1a", color: "#fff" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TeamSetup, { onStart: handleStart }) });
  }
  if (!state) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", background: "#0d0d1a", color: "#fff" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      position: "sticky",
      top: 0,
      zIndex: 20,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 14, fontWeight: 700 }, children: "战斗" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "#888", marginLeft: 8 }, children: state.phase === "fighting" ? "⚔️" : "🏁" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 6 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            onClick: () => {
              speed.current = speed.current === 1 ? 2 : speed.current === 2 ? 4 : 1;
            },
            style: btnStyle("#555"),
            children: [
              "⏱ ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowExtra(!showExtra), style: btnStyle("#555"), children: "📊 统计" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          reset();
          setPage("setup");
        }, style: btnStyle("#4caf50"), children: "⚙️ 配置" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 6 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BattleField, { battle: state, side: "ally", onUnitClick: setSelectedUnit }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", fontSize: 16, color: "#444", padding: "2px 0" }, children: "⚔" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BattleField, { battle: state, side: "enemy", onUnitClick: setSelectedUnit })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      padding: "4px 10px",
      fontSize: 11,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4fc3f7" }, children: "我方" }),
      " 存活",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#ef5350" }, children: "敌方" }),
      " 存活",
      state.units.filter((u) => u.team === "enemy" && !u.isDead).length,
      "/",
      state.units.filter((u) => u.team === "enemy").length
    ] }),
    showExtra && state.stats && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 6px 20px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatsPanel, { stats: state.stats }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 6 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BattleLog, { entries: state.battleLog })
    ] }),
    selectedUnit && /* @__PURE__ */ jsxRuntimeExports.jsx(UnitDetail, { unit: selectedUnit, onClose: () => setSelectedUnit(null) })
  ] });
};
