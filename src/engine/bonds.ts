...
import { BOND_EFFECTS, RACE_CONFIG } from '../data/races';

export interface BondInfo { race: Race; count: number; desc: string }

/** Compute active bonds from an array of unit definitions (used by TeamSetup) */
export function calcBondsFromDefs(units: { charId: string | null }[]): BondInfo[] {
